...
func (app *application) CreateCustomerAndSubscribeToPlan(w http.ResponseWriter, r *http.Request) {
	...
	app.infoLog.Println(data.Email, data.PaymentMethod, data.LastFour, data.Plan)
...
func (app *application) CreateAuthToken(w http.ResponseWriter, r *http.Request) {
	...
	// get the user from the database by email; send error if email is invalid
	user, err := app.DB.GetUserByEmail(userInput.Email)
	if err != nil {
		app.invalidCredentials(w)
		return
	}
	// validate the password; send error if password is invalid
...
func (app *application) CheckAuthentication(w http.ResponseWriter, r *http.Request) {
	...
	payload.Error = false
	payload.Message = fmt.Sprintf("an authenticated user %s", user.Email)
...
func (app *application) SendPasswordResetEmail(w http.ResponseWriter, r *http.Request) {
	...
	resp.Error = false
	resp.Message = "mail has been sent"
...
func (app *application) EditUser(w http.ResponseWriter, r *http.Request) {
	...
	resp.Error = false
	resp.Message = "User has been edited"
