...
// VirtualTerminalPaymentSucceeded displays the receipt page for virtual terminal page
...
// VirtualTerminalReceipt displays receipt page
...
// PostLoginPage displays the login page
